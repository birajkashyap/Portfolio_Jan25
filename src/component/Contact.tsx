            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  <a href="mailto:kashyapbiraj83@gmail.com">
                ...
                <div className="flex items-center space-x-4">
                  <a href="tel:+919007705656">
                    <Phone className="w-6 h-6 text-purple-400" />
                  </a>
                  <span className="text-gray-300">+91 9007705656</span>
                </div>
                <div className="flex items-center space-x-4">
                  <MapPin className="w-6 h-6 text-purple-400" />
                  <span className="text-gray-300">Gurgaon,India</span>
                </div>
              </div>
            </div>
            {/* here is input */}
